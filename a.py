...
arduino = serial.Serial('COM8', 9600)  # Sesuaikan baud rate sesuai dengan Arduino Anda
...
while True:
    ...
    for box in result.boxes:
        if box.conf > 0.8:  # Confidence threshold
            ...
            # Determine position of the ball relative to the center
            if box_height >= (3 * frame_height) // 4:
                command = 'S'
